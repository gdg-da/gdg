                ...
                <div className="flex flex-col md:flex-row items-center gap-8">
                    <div className="mx-auto">
                        ...
                        <div className="flex gap-4 justify-center">
                            <Button size="lg" className="comic-red comic-highlight random-rotate hover:-translate-y-1 transition-transform"><a href='https://chat.whatsapp.com/EOUef2JNbFB5hadvb48OWC' target='_blank'>Join Community</a></Button>
                            {/* <Button size="lg" variant="outline" className="comic-yellow comic-text random-rotate hover:-translate-y-1 transition-transform">Learn More</Button> */}
                        </div>
                    </div>
            ...
            <section>
                <div className="comic-card space-y-6 comic-dots">
                    {features.fearures.map((feature, index) => (
                        <div key={index} className="comic-red flex items-center gap-4 p-4 comic-border bg-[#FFD6A5]/20 random-rotate">
                ...
                <div className="comic-card grid grid-cols-2 md:grid-cols-4 gap-8 comic-stripes">
                    {Technologies.map((tech, index) => (
                        <div key={index} className="text-center">
                            <div className="comic-yellow comic-border bg-[#FFB1B1]/20 p-4 mb-4 mx-auto w-20 h-20 flex items-center justify-center random-rotate">
                                {tech.icon}
                            </div>
            ...
            <section>
                ...
                <div className="comic-card space-y-6 comic-checkered-grid">
                    {GrowWithUs.map((step, index) => (
                        <div key={index} className="comic-green flex items-center gap-4 p-4 comic-border bg-[#FFD6A5]/20 random-rotate">
                            <ArrowRight className="h-6 w-6" />
