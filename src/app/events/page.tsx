...
const events = [
  ...
  },
  {
    ...
    type: "National Event",
    description:
      "Dev-o-lution is a tech conference where coding meets creativity, and innovation breaks free from convention. Join us for workshops, talks, and mind-expanding sessions that will revolutionize your dev skills!",
    date: "19th Jan 2025",
    image:
      "https://github.com/gdg-da/devolution/blob/main/public/planet.png?raw=true",
  ...
  return (
    <div>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {events
            .sort((a, b) => b.id - a.id) // Sort events by ID in descending order
            .map((event, index) => (
              <div
                key={event.id}
                className="comic-panel animate-scaleIn"
